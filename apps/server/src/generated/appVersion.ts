export const appVersion = {
  ...
  "displayVersion": "v0.13.3-ALPHA",
  "packageVersion": "0.13.3-alpha",
  "channel": "ALPHA",
  "publisher": "TapTap Maker",
  "description": "TapTap Maker 本地桌面工作台",
  "announcementTitle": "v0.13.3-ALPHA 测试包",
  "announcementBody": "## v0.13.3-ALPHA 测试包\n\nAlpha 测试版本。用于验证静态更新清单能展示 `0.13.3`，并支持从 `0.13.1` 选择指定版本下载安装。",
  ...
  "announcements": [
    ...
    {
      "title": "v0.13.3-ALPHA 测试包",
      "body": "## v0.13.3-ALPHA 测试包\n\nAlpha 测试版本。用于验证静态更新清单能展示 `0.13.3`，并支持从 `0.13.1` 选择指定版本下载安装。"
    }
  ]
} as const;
