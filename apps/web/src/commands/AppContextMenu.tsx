...
> = {
  ...
  asset: [
    ...
    "asset.rename",
    "asset.move",
    { type: "separator", id: "asset:clipboard" },
    "asset.cut",
    "asset.copy",
  ...
  assetList: [
    "assetList.createFolderHere",
    "assetList.pasteHere",
    "app.refreshCurrent",
    "assetList.importFilesHere",
    "assetList.importFolderHere",
    "assetList.openCurrentDirectory",
    "assetList.copyCurrentDirectoryPath",
    "assetList.copyCurrentDirectoryAbsolutePath",
    "assetList.selectAll",
    { type: "separator", id: "assetList:selection" },
  ...
  assetDirectory: [
    "assetDirectory.open",
    "assetDirectory.createFolder",
    "assetDirectory.importFilesHere",
    "assetDirectory.importFolderHere",
    "assetDirectory.rename",
    "assetDirectory.cut",
    "assetDirectory.copy",
    "assetDirectory.move",
    "assetDirectory.copyFolder",
    "assetDirectory.pasteHere",
    { type: "separator", id: "assetDirectory:clipboard" },
