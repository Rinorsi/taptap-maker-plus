  ...
  return (
    ...
    >
      ...
      <CommandMenu.List className="max-h-[500px] overflow-y-auto p-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
        ...
        <CommandMenu.Group
          heading="快捷命令"
          className="[&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-2 [&_[cmdk-group-heading]]:pt-3 [&_[cmdk-group-heading]]:text-[11px] [&_[cmdk-group-heading]]:font-semibold [&_[cmdk-group-heading]]:text-text-muted/60 [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-widest"
        >
          {commands.map((command) => (
            <CommandMenu.Item
              ...
              keywords={[
                command.commandId,
                ...commandScopeKeywords(command.scope),
              ]}
              onSelect={() => {
                close();
              ...
              className={cn(
                ...
                command.danger
                  ? "aria-selected:bg-red-500/10 text-[#e06c75]"
                  : "aria-selected:bg-brand/15 text-text",
              )}
            >
              <div className="flex-1 min-w-0">
                <div
                  className={cn(
                    ...
                    command.danger
                      ? "group-aria-selected:text-red-400"
                      : "group-aria-selected:text-brand-strong",
                  )}
                >
                  {command.title}
                </div>
...
function commandScopeKeywords(scope: import("./types").Command["scope"]) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <strong className="block truncate text-[13px] font-medium text-text group-aria-selected:text-brand-strong transition-colors">
          {title}
        </strong>
        <span className="mt-0.5 block truncate text-[11px] text-text-subtle group-aria-selected:text-brand/70 transition-colors">
          {subtitle}
        </span>
      </div>
