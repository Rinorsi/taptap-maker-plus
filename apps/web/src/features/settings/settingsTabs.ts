...
export const settingsTabs: Array<{ id: SettingsTab; label: string; icon: LucideIcon; keywords: string[] }> = [
  ...
  { id: "advanced", label: "高级", icon: Bug, keywords: ["高级", "诊断", "日志", "通知", "开发者", "开发者模式", "调试日志", "系统级调试日志", "Chromium DevTools", "Open Devtools", "检查器", "重置软件", "恢复初始", "初始状态", "未绑定", "清空项目列表", "项目列表", "任务资产索引", "设置偏好", "停止 MCP 运行时", "确认重置", "输入重置软件", "浏览器", "Chromium", "DevTools", "同源策略", "CORS", "缓存", "硬性重新加载", "右键菜单", "原生菜单", "权限", "工作区访问", "工作区访问策略", "自动执行", "确认机制", "工具权限", "执行终端命令", "终端命令", "总是询问", "管理策略", "个性化", "GPT-5.4", "项目上下文", "AI 助手", "助手偏好", "自动附加项目上下文", "自定义指令", "编辑规则", "高级诊断报告", "诊断报告", "诊断包", "导出诊断包", "本地运行日志", "日志缓存", "清空日志", "保留策略", "14 天", "运行记录"] },
];
