...
export const settingsTabs: Array<{ id: SettingsTab; label: string; icon: LucideIcon; keywords: string[] }> = [
  { id: "workspaces", label: "工作区", icon: Box, keywords: ["默认值", "新项目", "全局初始化", "模板", "工作空间", "项目初始化", "工作区默认值"] },
  { id: "project", label: "项目", icon: FolderCog, keywords: ["Maker 项目根目录", "Maker", "项目根目录", "项目目录", "扫描项目", "删除本地项目文件夹", "确认目录", "选择目录", "保存并扫描", "当前打开项目"] },
  ...
  { id: "appearance", label: "外观", icon: Palette, keywords: ["界面", "主题", "深色", "暗色", "浅色", "亮色", "跟随系统", "代码编辑器", "编辑器主题", "字号", "字体大小", "自动换行", "显示行号", "行号"] },
  { id: "personalization", label: "个性化", icon: Bot, keywords: ["默认模型", "GPT-5.4", "项目上下文", "AI 助手", "助手偏好", "自动附加项目上下文", "自定义指令", "编辑规则"] },
